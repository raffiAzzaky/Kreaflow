  ...
  return (
    <AuthLayoutWrapper>
      <div className="mb-10 text-center lg:text-left">
        ...
        <p className="text-gray-400 text-sm">Ready to create your journey?</p>
      </div>

      {/* Tabs */}
      <div className="flex border-b border-white/10 mb-8">
        <Link href="/login" className="flex-1 pb-3 text-center text-gray-500 hover:text-gray-300 font-medium transition-colors">Login</Link>
        <div className="flex-1 pb-3 text-center border-b-2 border-blue-500 text-white font-medium">Sign Up</div>
      </div>

      <form className="space-y-4" onSubmit={handleSignUp}>
        <div className="space-y-1.5">
          <label className="text-xs text-white">Email Address</label>
          <input type="email" placeholder="john.doe@example.com" className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-2.5 text-sm text-white placeholder-gray-600 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all font-light" />
        </div>

        <div className="space-y-1.5">
          <label className="text-xs text-white">Phone Number</label>
          <input type="tel" placeholder="+123456789" className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-2.5 text-sm text-white placeholder-gray-600 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all font-light" />
        </div>

        <div className="space-y-1.5">
          <label className="text-xs text-white">Username</label>
          <input type="text" placeholder="johndoe" className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-2.5 text-sm text-white placeholder-gray-600 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all font-light" />
        </div>

        <div className="space-y-1.5">
          <label className="text-xs text-white">Password</label>
          <input type="password" placeholder="••••••••" className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-2.5 text-sm text-white placeholder-gray-600 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all font-light" />
        </div>
